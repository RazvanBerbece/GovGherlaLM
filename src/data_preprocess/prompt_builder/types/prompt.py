class Prompt:
    ...
    def __init__(self, author_to_reply: str, input: str, input_author: str, output: str, other_authors):
        self.instruction = f"Your name is {author_to_reply}."\
        " You are in a group chat with {} of your best friends: {}.".format(len(other_authors), ", ".join(other_authors)) + \
